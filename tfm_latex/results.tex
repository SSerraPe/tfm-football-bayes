...
(distance $0.16$) --- both plausible, well-known pairings. The next two subsections show what changes when the
same question is asked with full posterior uncertainty attached.
