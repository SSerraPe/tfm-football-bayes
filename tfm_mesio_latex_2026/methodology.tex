...
Whether shared player-level covariance is worth modelling at all is answered decisively, and is reported in Chapter~\ref{chap:results}; the choice of rank among $K \geq 1$ is argued qualitatively, as follows.
